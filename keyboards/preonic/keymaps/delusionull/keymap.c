...
[_LOWER] = {
  ...
  {_______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PENT, _______},
...
[_RAISE] = {
  ...
  {_______, KC_F5,   KC_F6,   KC_F7,   LCTL(KC_V), LCTL(KC_C), _______,    _______, _______, _______, KC_RGHT, KC_DEL},
  {_______, KC_F8,   KC_F9,   KC_F10,  LCTL(KC_Z), _______,    LCTL(KC_X), KC_LEFT, _______, _______, _______, _______},
  {_______, KC_F11,  KC_F12,  KC_DOWN, KC_UP,      _______,    _______,    _______, _______, _______, _______, KC_BSLS},
